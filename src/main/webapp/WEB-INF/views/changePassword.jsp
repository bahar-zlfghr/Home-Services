...
<head>
    ...
    <script src="${pageContext.request.contextPath}/static/js/validateChangePassword.js"></script>
...
<c:if test="${successChange eq true}">
    <div style="text-align: center" class="alert alert-success" role="alert">Your password changed successfully</div>
</c:if>
    ...
    <div class="table-responsive" style="padding: 100px">
        <table class="table">
            ...
            <tr>
                ...
                <td><input id="email" name="email" value="${email}" class="form-control" placeholder="Email" aria-label="Username" aria-describedby="basic-addon1" readonly/></td>
            </tr>
            <tr>
                <td></td>
                <td></td>
            ...
            <tr>
                ...
                <td><input type="password" name="previousPassword" id="previousPassword" class="form-control" placeholder="Password" aria-label="Username" aria-describedby="basic-addon1"/></td>
            </tr>
            <tr>
                <td></td>
                <td>
                    <span cssClass="error" class="error" id="previousPasswordError"></span>
                    <span cssClass="error" class="error">${passwordNotMatched}</span>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="password" name="newPassword" id="newPassword" class="form-control" placeholder="Password" aria-label="Username" aria-describedby="basic-addon1"/></td>
            </tr>
            <tr>
                <td></td>
                <td>
                    <span cssClass="error" class="error" id="newPasswordError"></span>
                </td>
            </tr>

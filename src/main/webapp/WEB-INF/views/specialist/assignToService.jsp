...
<head>
    ...
    <script src="${pageContext.request.contextPath}/static/js/assignToService.js"></script>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta charset="utf-8">
    <meta name="keywords" content="">
    <meta name="description" content="">
    <meta name="page_type" content="np-template-header-footer-from-plugin">
    <title>Assign To Service</title>
...
<c:if test="${successAssignToService eq true}">
    <div style="text-align: center" class="alert alert-success" role="alert">Assign To Sub Service Successfully</div>
</c:if>

<form:form cssClass="p-5"
           method="POST"
           action="/specialist/assign-service"
           onsubmit="return validateAssignToServiceForm()">

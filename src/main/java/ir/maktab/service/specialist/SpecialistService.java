...
public interface SpecialistService {
    ...
    void saveSpecialist(SpecialistDto specialistDto) throws NotEmptyException, DuplicateEmailException;
    void updateSpecialistStatus(Integer id, UserStatus status) ;
